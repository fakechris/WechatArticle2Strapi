...
// EXTERNAL MODULE: ./shared/node_modules/transliteration/dist/browser/bundle.umd.min.js
var bundle_umd_min = __webpack_require__(813);
...
function generateSlug(text) {
  ...
  try {
    ...
    const slug = (0,bundle_umd_min.slugify)(text, {
      lowercase: true,
      separator: '-',
      trim: true
    });
 ...
 */
async function generateSlugAsync(title, options = {}) {
      ...
      try {
        ...
        if (typeof process !== 'undefined' && process.versions && process.versions.node) {
          ...
          const [axiosModule, imageSizeModule] = await Promise.all([
            this.importAxios(),
            __webpack_require__.e(/* import() */ 657).then(__webpack_require__.bind(__webpack_require__, 657))
          ]);
